            ...
            <div class="row">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h3 class="page-title">បញ្ចូលការនិមន្ត</h3>
                            </div>
                        </div>
                    </div>
                    <!-- /Page Header -->
                                ...
                                <div class="card-body rounded">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bun_name" name="bun_name"
                                            value="{{ old('bun_name') }}" placeholder="បញ្ចូលឈ្មោះកម្មវីធីបុណ្យ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="person_name" name="person_name"
                                            value="{{ old('person_name') }}" placeholder="ឈ្មោះអ្នកនិមន្ត">
                                ...
                                <div class="card-body rounded">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address"
                                            value="{{ old('address') }}" placeholder="ទីកន្លែងបុណ្យ">
                                    </div>
                                    <div class="form-group">
                                        <label>ជ្រើសរើសភូមិ</label>
