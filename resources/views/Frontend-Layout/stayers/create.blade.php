        ...
        <div class="content container-fluid">
            <div class="row">
             ...
             <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">បញ្ចូលព័ត៌មានរបស់ស្នាក់នៅក្នុងវត្ត</h3>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
            <form action="{{ route('stayer.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group mb-4">
                                <div class="text-center border-0 mt-4 px-2 w-25 mx-auto">
                                    <img src="{{ !empty($stayers->stayer_image)
                                        ? url('upload/stayers_img/' . $stayers->stayer_image)
